  ...
  >
    ...
    >
      ...
      >
        ...
        <img :src="require('./../../' + option.url)" />
        <label>{{ option.network }}</label>
      </div>
    </div>
    <div
    ...
    >
      ...
      <div v-if="selected__opc" class="selected_option">
        <img :src="require('./../../' + selected__img)" />{{ selected__opc }}
      </div>
      <svg
        width="16"
        height="16"
    ...
    set__selected(option) {
      ...
      if (option.network) {
        if (option.network.length > 1) {
          ...
          this.selected__opc = option.network.toUpperCase();
        }
