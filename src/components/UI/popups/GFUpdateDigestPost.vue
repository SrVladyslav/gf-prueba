  ...
  <div class="update_container" @click.self="closeTab()">
    <div class="update_window">
      ...
      <div class="scrollable_container">
        ...
        <gf-select-box
          v-model="post_to_update.digest_group"
        ...
        <gf-input-field
          v-model="post_to_update.source_link"
          :showError="errors.source_link_error"
          :showRequired="true"
        >
        ...
        <gf-input-field
          v-model="post_to_update.source"
          :showError="errors.source_error"
          :showRequired="true"
        >
...
export default {
  ...
  methods: {
    ...
    async updatePost() {
      ...
      fd.append("source_link", this.post_to_update.source_link);
      fd.append("source", this.post_to_update.source);
      let dgGroup = this.group_to_id[this.post_to_update.digest_group];
